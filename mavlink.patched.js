...
mavlink.GIMBAL_MANAGER_CAP_FLAGS_CAN_POINT_LOCATION_GLOBAL = 131072 // Gimbal manager supports to point to a global latitude, longitude,
                        // altitude position.
mavlink.GIMBAL_MANAGER_CAP_FLAGS_HAS_TRACKING_POINT = 262144 // Gimbal manager supports tracking of a point on the camera.
mavlink.GIMBAL_MANAGER_CAP_FLAGS_HAS_TRACKING_RECTANGLE = 524288 // Gimbal manager supports tracking of a point on the camera.
mavlink.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_FOCAL_LENGTH_SCALE = 1048576 // Gimbal manager supports pitching and yawing at an angular velocity
                        // scaled by focal length (the more zoomed in,
                        // the slower the movement).
mavlink.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_NUDGING = 2097152 // Gimbal manager supports nudging when pointing to a location or
                        // tracking.
mavlink.GIMBAL_MANAGER_CAP_FLAGS_SUPPORTS_OVERRIDE = 4194304 // Gimbal manager supports overriding when pointing to a location or
                        // tracking.
mavlink.GIMBAL_MANAGER_CAP_FLAGS_ENUM_END = 4194305 // 
...
mavlink.GIMBAL_MANAGER_FLAGS_ANGULAR_VELOCITY_RELATIVE_TO_FOCAL_LENGTH = 1048576 // Scale angular velocity relative to focal length. This means the gimbal
                        // moves slower if it is zoomed in.
mavlink.GIMBAL_MANAGER_FLAGS_NUDGE = 2097152 // Interpret attitude control on top of pointing to a location or
                        // tracking. If this flag is set, the
                        // quaternion is relative to the existing
                        // tracking angle.
mavlink.GIMBAL_MANAGER_FLAGS_OVERRIDE = 4194304 // Completely override pointing to a location or tracking. If this flag
                        // is set, the quaternion is (as usual)
                        // according to GIMBAL_MANAGER_FLAGS_YAW_LOCK.
mavlink.GIMBAL_MANAGER_FLAGS_ENUM_END = 4194305 // 
...
mavlink.GIMBAL_DEVICE_ERROR_FLAGS_ENUM_END = 129 // 
...
mavlink.MAV_CMD_DO_JUMP_TAG = 601 // Jump to the matching tag in the mission list. Repeat this action for
                        ...
                        // number.
mavlink.MAV_CMD_DO_GIMBAL_MANAGER_ATTITUDE = 1000 // High level setpoint to be sent to a gimbal manager to set a gimbal
                        ...
                        // gimbal manager.
mavlink.MAV_CMD_DO_GIMBAL_MANAGER_TRACK_POINT = 1001 // If the gimbal manager supports visual tracking
                        // (GIMBAL_MANAGER_CAP_FLAGS_HAS_TRACKING_POIN
                        // T is set), this command allows to initiate
                        // the tracking. Such a tracking gimbal
                        // manager would usually be an integrated
                        // camera/gimbal, or alternatively a companion
                        // computer connected to a camera.
mavlink.MAV_CMD_DO_GIMBAL_MANAGER_TRACK_RECTANGLE = 1002 // If the gimbal supports visual tracking
                        // (GIMBAL_MANAGER_CAP_FLAGS_HAS_TRACKING_RECT
                        // ANGLE is set), this command allows to
                        // initiate the tracking. Such a tracking
                        // gimbal manager would usually be an
                        // integrated camera/gimbal, or alternatively
                        // a companion computer connected to a camera.
...
mavlink.MAV_ODID_UA_TYPE_ROTORCRAFT = 2 // Rotorcraft (including Multirotor).
mavlink.MAV_ODID_UA_TYPE_GYROPLANE = 3 // Gyroplane.
mavlink.MAV_ODID_UA_TYPE_VTOL = 4 // VTOL (Vertical Take-Off and Landing). Fixed wing aircraft that can
                        // take off vertically.
...
mavlink.MAV_ODID_UA_TYPE_FREE_FALL_PARACHUTE = 11 // Free Fall/Parachute.
...
mavlink.MAV_ODID_STATUS_ENUM_END = 3 // 
...
mavlink.MAV_ODID_TIME_ACC_0_1_SECOND = 1 // The timestamp accuracy is smaller than 0.1 second.
mavlink.MAV_ODID_TIME_ACC_0_2_SECOND = 2 // The timestamp accuracy is smaller than 0.2 second.
mavlink.MAV_ODID_TIME_ACC_0_3_SECOND = 3 // The timestamp accuracy is smaller than 0.3 second.
mavlink.MAV_ODID_TIME_ACC_0_4_SECOND = 4 // The timestamp accuracy is smaller than 0.4 second.
mavlink.MAV_ODID_TIME_ACC_0_5_SECOND = 5 // The timestamp accuracy is smaller than 0.5 second.
mavlink.MAV_ODID_TIME_ACC_0_6_SECOND = 6 // The timestamp accuracy is smaller than 0.6 second.
mavlink.MAV_ODID_TIME_ACC_0_7_SECOND = 7 // The timestamp accuracy is smaller than 0.7 second.
mavlink.MAV_ODID_TIME_ACC_0_8_SECOND = 8 // The timestamp accuracy is smaller than 0.8 second.
mavlink.MAV_ODID_TIME_ACC_0_9_SECOND = 9 // The timestamp accuracy is smaller than 0.9 second.
mavlink.MAV_ODID_TIME_ACC_1_0_SECOND = 10 // The timestamp accuracy is smaller than 1.0 second.
mavlink.MAV_ODID_TIME_ACC_1_1_SECOND = 11 // The timestamp accuracy is smaller than 1.1 second.
mavlink.MAV_ODID_TIME_ACC_1_2_SECOND = 12 // The timestamp accuracy is smaller than 1.2 second.
mavlink.MAV_ODID_TIME_ACC_1_3_SECOND = 13 // The timestamp accuracy is smaller than 1.3 second.
mavlink.MAV_ODID_TIME_ACC_1_4_SECOND = 14 // The timestamp accuracy is smaller than 1.4 second.
mavlink.MAV_ODID_TIME_ACC_1_5_SECOND = 15 // The timestamp accuracy is smaller than 1.5 second.
...
mavlink.MAV_ODID_LOCATION_SRC_TAKEOFF = 0 // The location of the operator is the same as the take-off location.
mavlink.MAV_ODID_LOCATION_SRC_LIVE_GNSS = 1 // The location of the operator is based on live GNSS data.
mavlink.MAV_ODID_LOCATION_SRC_FIXED = 2 // The location of the operator is a fixed location.
mavlink.MAV_ODID_LOCATION_SRC_ENUM_END = 3 // 
...
*/
mavlink.messages.gimbal_manager_information = function(time_boot_ms, cap_flags, gimbal_component, tilt_max, tilt_min, tilt_rate_max, pan_max, pan_min, pan_rate_max) {
    ...
    this.fieldnames = ['time_boot_ms', 'cap_flags', 'gimbal_component', 'tilt_max', 'tilt_min', 'tilt_rate_max', 'pan_max', 'pan_min', 'pan_rate_max'];
...
mavlink.messages.gimbal_manager_information.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.cap_flags, this.tilt_max, this.tilt_min, this.tilt_rate_max, this.pan_max, this.pan_min, this.pan_rate_max, this.gimbal_component]));
}
...
*/
mavlink.messages.gimbal_manager_status = function(time_boot_ms, flags) {
    ...
    this.fieldnames = ['time_boot_ms', 'flags'];
...
mavlink.messages.gimbal_manager_status.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.flags]));
}
...
*/
mavlink.messages.gimbal_manager_set_attitude = function(target_system, target_component, flags, q, angular_velocity_x, angular_velocity_y, angular_velocity_z) {

    this.format = '<I4ffffBB';
    this._id = mavlink.MAVLINK_MSG_ID_GIMBAL_MANAGER_SET_ATTITUDE;
    this.order_map = [5, 6, 0, 1, 2, 3, 4];
    this.crc_extra = 252;
...
mavlink.messages.gimbal_manager_set_attitude.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.flags, this.q, this.angular_velocity_x, this.angular_velocity_y, this.angular_velocity_z, this.target_system, this.target_component]));
}
...
*/
mavlink.messages.gimbal_device_information = function(time_boot_ms, vendor_name, model_name, firmware_version, cap_flags, tilt_max, tilt_min, tilt_rate_max, pan_max, pan_min, pan_rate_max) {
...
mavlink.messages.gimbal_device_information.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.firmware_version, this.tilt_max, this.tilt_min, this.tilt_rate_max, this.pan_max, this.pan_min, this.pan_rate_max, this.cap_flags, this.vendor_name, this.model_name]));
}
...
*/
mavlink.messages.gimbal_device_attitude_status = function(time_boot_ms, flags, q, angular_velocity_x, angular_velocity_y, angular_velocity_z, failure_flags) {

    this.format = '<I4ffffIH';
    this._id = mavlink.MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS;
    this.order_map = [0, 6, 1, 2, 3, 4, 5];
    this.crc_extra = 82;
    this.name = 'GIMBAL_DEVICE_ATTITUDE_STATUS';

    this.fieldnames = ['time_boot_ms', 'flags', 'q', 'angular_velocity_x', 'angular_velocity_y', 'angular_velocity_z', 'failure_flags'];
...
mavlink.messages.gimbal_device_attitude_status.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.q, this.angular_velocity_x, this.angular_velocity_y, this.angular_velocity_z, this.failure_flags, this.flags]));
}
...
*/
mavlink.messages.autopilot_state_for_gimbal_device = function(time_boot_us, target_system, target_component, q, q_estimated_delay_us, vx, vy, vz, v_estimated_delay_us, feed_forward_angular_velocity_z) {

    this.format = '<Q4fIfffIfBB';
    this._id = mavlink.MAVLINK_MSG_ID_AUTOPILOT_STATE_FOR_GIMBAL_DEVICE;
    this.order_map = [0, 8, 9, 1, 2, 3, 4, 5, 6, 7];
    this.crc_extra = 62;
    this.name = 'AUTOPILOT_STATE_FOR_GIMBAL_DEVICE';

    this.fieldnames = ['time_boot_us', 'target_system', 'target_component', 'q', 'q_estimated_delay_us', 'vx', 'vy', 'vz', 'v_estimated_delay_us', 'feed_forward_angular_velocity_z'];
...
mavlink.messages.autopilot_state_for_gimbal_device.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_us, this.q, this.q_estimated_delay_us, this.vx, this.vy, this.vz, this.v_estimated_delay_us, this.feed_forward_angular_velocity_z, this.target_system, this.target_component]));
}
...
mavlink.messages.smart_battery_status = function(id, capacity_remaining, current, temperature, fault_bitmask, time_remaining, cell_offset, voltages) {
    ...
    this._id = mavlink.MAVLINK_MSG_ID_SMART_BATTERY_STATUS;
...
*/
mavlink.messages.component_information = function(time_boot_ms, vendor_name, model_name, firmware_version, hardware_version, capability_flags, component_definition_version, component_definition_uri) {

    this.format = '<IIIIH32s32s140s';
    this._id = mavlink.MAVLINK_MSG_ID_COMPONENT_INFORMATION;
    this.order_map = [0, 5, 6, 1, 2, 3, 4, 7];
    this.crc_extra = 231;
    this.name = 'COMPONENT_INFORMATION';

    this.fieldnames = ['time_boot_ms', 'vendor_name', 'model_name', 'firmware_version', 'hardware_version', 'capability_flags', 'component_definition_version', 'component_definition_uri'];
...
mavlink.messages.component_information.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.time_boot_ms, this.firmware_version, this.hardware_version, this.capability_flags, this.component_definition_version, this.vendor_name, this.model_name, this.component_definition_uri]));
}
...
*/
mavlink.messages.open_drone_id_basic_id = function(id_type, ua_type, uas_id) {
    ...
    this.fieldnames = ['id_type', 'ua_type', 'uas_id'];
...
mavlink.messages.open_drone_id_basic_id.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.id_type, this.ua_type, this.uas_id]));
}
...
*/
mavlink.messages.open_drone_id_location = function(status, direction, speed_horizontal, speed_vertical, latitude, longitude, altitude_barometric, altitude_geodetic, height_reference, height, horizontal_accuracy, vertical_accuracy, barometer_accuracy, speed_accuracy, timestamp, timestamp_accuracy) {

    this.format = '<iiffffHHhBBBBBBB';
    this._id = mavlink.MAVLINK_MSG_ID_OPEN_DRONE_ID_LOCATION;
    this.order_map = [9, 6, 7, 8, 0, 1, 2, 3, 10, 4, 11, 12, 13, 14, 5, 15];
    this.crc_extra = 16;
    this.name = 'OPEN_DRONE_ID_LOCATION';

    this.fieldnames = ['status', 'direction', 'speed_horizontal', 'speed_vertical', 'latitude', 'longitude', 'altitude_barometric', 'altitude_geodetic', 'height_reference', 'height', 'horizontal_accuracy', 'vertical_accuracy', 'barometer_accuracy', 'speed_accuracy', 'timestamp', 'timestamp_accuracy'];
...
through 4, PageCount,Length and TimeStamp are not present and the size
...
*/
mavlink.messages.open_drone_id_authentication = function(authentication_type, data_page, page_count, length, timestamp, authentication_data) {

    this.format = '<IBBBB23s';
    ...
    this.fieldnames = ['authentication_type', 'data_page', 'page_count', 'length', 'timestamp', 'authentication_data'];
...
mavlink.messages.open_drone_id_authentication.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.timestamp, this.authentication_type, this.data_page, this.page_count, this.length, this.authentication_data]));
}
...
*/
mavlink.messages.open_drone_id_self_id = function(description_type, description) {
    ...
    this.fieldnames = ['description_type', 'description'];
...
mavlink.messages.open_drone_id_self_id.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.description_type, this.description]));
}
...
*/
mavlink.messages.open_drone_id_system = function(flags, operator_latitude, operator_longitude, area_count, area_radius, area_ceiling, area_floor) {

    this.format = '<iiffHHB';
    this._id = mavlink.MAVLINK_MSG_ID_OPEN_DRONE_ID_SYSTEM;
    this.order_map = [6, 0, 1, 4, 5, 2, 3];
    this.crc_extra = 238;
    this.name = 'OPEN_DRONE_ID_SYSTEM';

    this.fieldnames = ['flags', 'operator_latitude', 'operator_longitude', 'area_count', 'area_radius', 'area_ceiling', 'area_floor'];
...
mavlink.messages.open_drone_id_system.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.operator_latitude, this.operator_longitude, this.area_ceiling, this.area_floor, this.area_count, this.area_radius, this.flags]));
}
...
*/
mavlink.messages.open_drone_id_operator_id = function(operator_id_type, operator_id) {
    ...
    this.fieldnames = ['operator_id_type', 'operator_id'];
...
mavlink.messages.open_drone_id_operator_id.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.operator_id_type, this.operator_id]));
}
...
*/
mavlink.messages.open_drone_id_message_pack = function(single_message_size, msg_pack_size, messages) {
    ...
    this.fieldnames = ['single_message_size', 'msg_pack_size', 'messages'];
...
mavlink.messages.open_drone_id_message_pack.prototype.pack = function(mav) {
    return mavlink.message.prototype.pack.call(this, mav, this.crc_extra, jspack.Pack(this.format, [ this.single_message_size, this.msg_pack_size, this.messages]));
}
...
mavlink.map = {
        ...
        124: { format: '<QiiiIHHHHBBBH', type: mavlink.messages.gps2_raw, order_map: [0, 9, 1, 2, 3, 5, 6, 7, 8, 10, 11, 4, 12], crc_extra: 87 },
        ...
        280: { format: '<IIffffffB', type: mavlink.messages.gimbal_manager_information, order_map: [0, 1, 8, 2, 3, 4, 5, 6, 7], crc_extra: 128 },
        281: { format: '<II', type: mavlink.messages.gimbal_manager_status, order_map: [0, 1], crc_extra: 252 },
        282: { format: '<I4ffffBB', type: mavlink.messages.gimbal_manager_set_attitude, order_map: [5, 6, 0, 1, 2, 3, 4], crc_extra: 252 },
        283: { format: '<IIffffffH32s32s', type: mavlink.messages.gimbal_device_information, order_map: [0, 9, 10, 1, 8, 2, 3, 4, 5, 6, 7], crc_extra: 247 },
        284: { format: '<4ffffHBB', type: mavlink.messages.gimbal_device_set_attitude, order_map: [5, 6, 4, 0, 1, 2, 3], crc_extra: 99 },
        285: { format: '<I4ffffIH', type: mavlink.messages.gimbal_device_attitude_status, order_map: [0, 6, 1, 2, 3, 4, 5], crc_extra: 82 },
        286: { format: '<Q4fIfffIfBB', type: mavlink.messages.autopilot_state_for_gimbal_device, order_map: [0, 8, 9, 1, 2, 3, 4, 5, 6, 7], crc_extra: 62 },
        ...
        395: { format: '<IIIIH32s32s140s', type: mavlink.messages.component_information, order_map: [0, 5, 6, 1, 2, 3, 4, 7], crc_extra: 231 },
        ...
        12900: { format: '<BB20s', type: mavlink.messages.open_drone_id_basic_id, order_map: [0, 1, 2], crc_extra: 197 },
        12901: { format: '<iiffffHHhBBBBBBB', type: mavlink.messages.open_drone_id_location, order_map: [9, 6, 7, 8, 0, 1, 2, 3, 10, 4, 11, 12, 13, 14, 5, 15], crc_extra: 16 },
        12902: { format: '<IBBBB23s', type: mavlink.messages.open_drone_id_authentication, order_map: [1, 2, 3, 4, 0, 5], crc_extra: 181 },
        12903: { format: '<B23s', type: mavlink.messages.open_drone_id_self_id, order_map: [0, 1], crc_extra: 149 },
        12904: { format: '<iiffHHB', type: mavlink.messages.open_drone_id_system, order_map: [6, 0, 1, 4, 5, 2, 3], crc_extra: 238 },
